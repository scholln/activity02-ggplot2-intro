...
**From these box plots we can see that Gentoo has a much larger flipper length compared to the other species**:
...
**The box plot is a cut and dry comparison of the spread of the varaibles but does have the weakness of not being able to see all the data points but a summary or metadata point of it**:
...
**I definitely prefer the md file as it displays all the photos and a pretty view of the code and responses**:
...
**Definitely the jitter over the box plot because we are able to see the entire jitter points instead of half or so with the box plot**:
...
**What I notice is its easier on the eyes than just looking at a color blob and piecing together what it is**:
...
**My guess would be species as we see the biggest differences in that graph compared to the others**:
...
**We can see a correlation between the variables but not a strong correlation**:
...
**The Gentoo species is definitely the largest penguins in terms of weight AND flipper length**:
...
**I chose sex and species because I believed those two values to have the greatest effect on the body mass and flipper length of the penguin.  That and Choosing finite values for alpha so it doesn't look too confusing and size to species**:
