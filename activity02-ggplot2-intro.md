...
**From these box plots we can see that Gentoo has a much larger flipper
length compared to the other species**:
...
**The box plot is a cut and dry comparison of the spread of the
varaibles but does have the weakness of not being able to see all the
data points but a summary or metadata point of it**:
...
**My guess would be species as we see the biggest differences in that
